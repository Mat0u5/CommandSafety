...
publishMods {
	...
	if (shouldAnnounceDiscord) {
		...
		discord("publishDiscordBody") {
			...
			if (!isDev) {
				content = changelog.map { "# [CommandSafety version `$version` is out!](https://modrinth.com/mod/commandsafety/versions)\n" +
					"### Changelog:\n" +
					"```\n$it```\n"  }
			}
			else {
				content = changelog.map { "# [CommandSafety version `$version` is out!](https://modrinth.com/mod/commandsafety-dev/versions)\n" +
					"### Changelog:\n" +
					"```\n$it```\n" }
			}
